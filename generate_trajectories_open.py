...
scipy.io.savemat(f'trajectory_data_final/channel/open/rejection/Ntraj={Ntraj}_T={system_params["T"]}_dt={system_params["T"]/system_params["N"]}_dth={system_params["D_theta"]}.mat', dict(x = trajectories[:, :, 0], 
                                                y= trajectories[:, :, 1], 
                                                theta = normalise_angles(trajectories[:, :, 2]),
